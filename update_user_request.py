...
# Update /user/request/page.tsx
user_request_content = '''."use client";
...
export default function CreateRequestPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setAlert({ type: "success", message: "Talep başarıyla oluşturuldu!" });
    setTimeout(() => {
  ...
  return (
    <UserLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Page title */}
        <div>
          <h1 className="text-3xl font-bold text-white">Kargo Talebi Oluştur</h1>
          <p className="mt-2 text-sm text-white/70">
            Yeni bir kargo talebi oluşturun. Talep oluşturulduktan sonra planlama yapıldığında rotaya dahil edilecektir.
          </p>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-cyan-300">
              ...
              <p className="text-cyan-300/80">
                Oluşturduğunuz talep &quot;Beklemede&quot; durumunda olacaktır. Sistem yöneticisi planlama yaptığında
                talebiniz otomatik olarak bir rotaya atanacak ve &quot;Planlandı&quot; durumuna geçecektir.
              </p>
            </div>
          </div>
        </div>
...
with open('c:/Users/Ebu-l Emin/Desktop/Yazlab3/apps/web/src/app/user/request/page.tsx', 'w', encoding='utf-8') as f:
    f.write(user_request_content)

print("User request page updated!")
