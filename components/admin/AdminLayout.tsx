...
export default function AdminLayout({
  ...
  const navLinks = [
    ...
    { href: "/admin/stations", label: t("İstasyonlar") },
    { href: "/admin/demands", label: t("Talepler") },
    { href: "/admin/planning", label: t("Planlama") },
    { href: "/admin/results", label: t("Sonuçlar") },
    { href: "/admin/runs", label: t("Geçmiş") },
  ];
